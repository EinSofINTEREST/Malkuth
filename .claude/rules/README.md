...
**Wiring a New Graph:**
1. Review [04-module-system.md](04-module-system.md) — graph topology modules
2. Validate topology (no dangling refs) before deployment
3. Add graph-level integration tests per [06-testing.md](06-testing.md)
